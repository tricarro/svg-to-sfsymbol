...
import { deepCloneElement, elementChildren, localTag, parseSvgXml, svgDocumentElement, } from "../svg/xml.js";
import { elementHasVisibleFill, elementHasVisibleStroke, representativeStrokeStyleForMixedPreprocess, } from "../routing/svgRouting.js";
...
function fillBoundaryToStrokedPathMarkup(el, flatness, strokeWidth, strokeColor) {
    ...
    return (`<path fill="${escapeSvgAttr(strokeColor)}" stroke="${escapeSvgAttr(strokeColor)}" stroke-width="${strokeWidth}" ` +
